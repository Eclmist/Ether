...
struct GIReservoir
{
    ...
    {
        GIReservoir reservoir;
        reservoir.m_Sample.m_VisibleNormal = OctahedralDecode(packedReservoir.m_PackedNormals.xy);
        reservoir.m_Sample.m_SampleNormal = OctahedralDecode(packedReservoir.m_PackedNormals.zw);
