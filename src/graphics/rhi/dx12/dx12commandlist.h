...
public:
    ...
    void CopyBufferToTexture(RhiResource& scratch, RhiResource& dest, void** data) override;
    void CopyTextureToBuffer(const RhiResource& src, RhiResource& dest) override;
    void CopyTextureRegionToBuffer(const RhiResource& src, RhiResource& dest, Rect rect) override;
