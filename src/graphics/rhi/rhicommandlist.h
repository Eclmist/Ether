...
public:
    ...
    virtual void SetGraphicPipelineState(const RhiGraphicPipelineState& pso) = 0;
    virtual void SetComputePipelineState(const RhiComputePipelineState& pso) = 0;
    ...
    virtual void CopyBufferToTexture(RhiResource& scratch, RhiResource& dest, void** data) = 0;
    virtual void CopyTextureToBuffer(const RhiResource& src, RhiResource& dest) = 0;
    virtual void CopyTextureRegionToBuffer(const RhiResource& src, RhiResource& dest, Rect rect) = 0;
