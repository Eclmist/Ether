...
#define DECLARE_GFX_AS(name) DECLARE_GFX_STATICRESOURCE(name, AS, GFX_AS_TYPE)
#define DECLARE_GFX_UA_SR(name) DECLARE_GFX_UA(name) DECLARE_GFX_SR(name)
...
#define DEFINE_GFX_UA_SR(name) DEFINE_GFX_UA(name) DEFINE_GFX_SR(name)
