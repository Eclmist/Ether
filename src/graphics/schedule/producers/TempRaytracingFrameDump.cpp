...
//}
//
//void Ether::Graphics::TempRaytracingFrameDump::GetInputOutput(ResourceContext& rc)
//{
...
//}
//
//bool Ether::Graphics::TempRaytracingFrameDump::IsEnabled()
//{
//    return GraphicCore::GetGraphicConfig().m_IsRaytracingEnabled;
//}
