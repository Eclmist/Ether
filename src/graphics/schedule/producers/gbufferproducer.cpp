...
void Ether::Graphics::GBufferProducer::GetInputOutput(ScheduleContext& schedule, ResourceContext& rc)
{
    ...
    schedule.NewDS(ACCESS_GFX_DS(GBufferDepthStencil), resolution.x, resolution.y, DepthBufferDsvFormat);
    ...
    schedule.NewRT(ACCESS_GFX_RT(GBufferTexture3), resolution.x, resolution.y, RhiFormat::R11G11B10Float);
    schedule.NewSR(ACCESS_GFX_SR(GBufferDepthStencil), resolution.x, resolution.y, DepthBufferSrvFormat, RhiResourceDimension::Texture2D);
    ...
    schedule.NewSR(ACCESS_GFX_SR(GBufferTexture3), resolution.x, resolution.y, RhiFormat::R11G11B10Float, RhiResourceDimension::Texture2D);
