...
{
    MSG msg = {};
    while (::PeekMessage(&msg, (HWND)m_ParentWindowHandle, 0, 0, PM_REMOVE))
    {
...
LRESULT CALLBACK Ether::Win32::Win32Window::WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
    {
        ...
        if (EngineCore::GetEngineConfig().GetClientSize() != newSize)
            EngineCore::GetEngineConfig().SetClientSize(newSize);
        break;
    }
    case WM_MOVE:
    {
    ...
    case WM_RBUTTONUP:
        ...
        break;
    case WM_DESTROY:
        ETH_ENGINEONLY(::PostQuitMessage(0));
        break;
    default:
        return ::DefWindowProc(hWnd, msg, wParam, lParam);
    }
