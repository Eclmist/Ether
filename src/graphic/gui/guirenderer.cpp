...
//    ImGui_ImplDX12_Init(
//        GraphicCore::GetDevice().Get(),
//        ETH_MAX_NUM_SWAPCHAIN_BUFFERS,
//        DXGI_FORMAT_R8G8B8A8_UNORM,
//        m_Context.GetSRVDescriptorHeap().Get(),
//        m_Context.GetSRVDescriptorHeap().GetCPUHandle(),
//        m_Context.GetSRVDescriptorHeap().GetGPUHandle()
//    );
//
//    SetImGuiStyle();
//}
...
//
//    ImGui::Render();
//    m_Context.TransitionResource(*GraphicCore::GetGraphicDisplay().GetCurrentBackBuffer(), D3D12_RESOURCE_STATE_RENDER_TARGET);
//    m_Context.SetRenderTarget(GraphicCore::GetGraphicDisplay().GetCurrentBackBufferRTV()->GetRTV());
//    m_Context.GetCommandList().SetDescriptorHeaps(1, m_Context.GetSRVDescriptorHeap().GetAddressOf());
